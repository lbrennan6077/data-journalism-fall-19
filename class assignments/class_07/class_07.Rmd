...
```{r}
  ...
  labs(x="Year", y="Total pills", title="In Logan County, opioid shipments stay steadily high from 2006 to 2012", subtitle = "Total pills shipped to Logan County by year", caption = "Source: DEA ARCOS database, via Washington Post") +
...
```{r}
# Scatterplot that explores the relationship between the following two factors for Maryland counties: the pills per person rate (not total pills, but pills per person) for a county in 2012 and the county's median household income in 2012.(Not updated)
