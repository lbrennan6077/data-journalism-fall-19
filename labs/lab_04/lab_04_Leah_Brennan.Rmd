...
#The manufacturer to distributor to pharmacy pipeline responsible for the largest number of pills being shipped to Mingo County is Actavis Pharma, Inc., Miami-Luken and Tug Valley Pharmacy, LLC. 
...
```{r}
#I would use the case_when function to create a separate grouping that isolates the Cardinal Health data. This would help me to clearly see the distributor, buyer and manufacturer in a row while combining the different locations into one object. 
