...
#Let's join median household income data from tidycensus with geography data from ARCOS 
...
BalCo_income_by_tract <- inner_join(BalCo_annual_buyer, BalCo_tract, by="BUYER_DEA_NO")
...
#might leave ZIP code error, tract data for pharmacies not perscribers, compare to other counties
