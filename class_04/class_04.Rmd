...
#Yeah, there's some, such as the transaction_ID and the drug_code. They don't need to be dbl because they're always the same.


#* Based on the information here, how are missing values represented in this data set?

#Missing values are presented as "null"s. 
...
#Two pharmacists were convicted for selling nearly 10 million addictive painkillers over the internet (https://www.baltimoresun.com/news/bs-xpm-2008-08-01-0807310258-story.html).

#The DEA "agents raided Newcare's 55,000-square-foot facility and arrested its owners." They got arrested for "selling 9,936,075 units of hydrocodone online using phony prescriptions; conspiracy to launder money; engaging in transactions involving the proceeds of drug sales; and filing false tax returns." https://www.baltimoresun.com/news/bs-xpm-2008-08-01-0807310258-story.html

#Paragraph I would write: Two pharamcists who worked for Newcare Pharmacy in Baltimore were found responsible for selling close to ten million pills while using fake perscriptions, laundering money and more. DEA agents raided the pharmacy, located at 400 block of Sinclair Lane in the city, and the pharamcists were convicted of selling the painkillers illegally in federal court. 
```
...
#the name of the distributor: Mckesson Corporation
#the number of pills sent between 2006 and 2012: 49834830
#the state where their corporate headquarters is located: Irving, Texas
...
#Professional Pharmacy Service, Sinai Hospital, 2411 West Belvedere Avenue, total shipment: 3352600. This pharmacy is unique because it's in a hospital.
```
...
#RITE AID OF MARYLAND, INC., (percentage of pills) 1.251900e+01, (total pills) 32300, (total number of pills to whole city) 133721503
...
#Total shipments = 1015276, per group = 864315, percent of total: 85.13
...
#I would likely use this to track down Cardinal Health, which has values very close to the top. 
